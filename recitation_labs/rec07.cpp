...
Displays[ Thing: 42 ] -> because actually modifying Thing& (returning the Thing&)
but setVal is a copy of 42, modifying the copy of 42 to = 25 which will not return 
the midified version.
