...
### Override
We went over this material on the previous lectuer but derived classes can override their parent class's methods. And can use the keyword `virtual` to make sure the derived class's method was being used. 